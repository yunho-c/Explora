...
const terminalTheme = (element: HTMLElement): ITheme => {
  ...
  return {
    ...
    foreground: token("--foreground", "#1f2328"),
    cursor: token("--foreground", "#1f2328"),
    cursorAccent: token("--background", "#ffffff"),
    selectionBackground: token("--accent", "#e8eaed"),
    selectionForeground: token("--accent-foreground", "#1f2328"),
    black: "#24292f",
    red: "#cf222e",
    green: "#1a7f37",
    yellow: "#9a6700",
